...
@Component({
  selector: 'app-fetch-with-input',
  templateUrl: './fetch-with-input.component.html',
  styleUrls: ['./fetch-with-input.component.scss']
})
export class FetchWithInputComponent implements OnInit {
